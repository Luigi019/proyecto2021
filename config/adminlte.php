...
//        ],
        [
            'text' => 'Formaciones',
            'route'  => 'panel.courses.index',
            'icon' => 'fas fa-book-open',

        ],
        [
            'text' => 'Solicitudes',
            'route'  => 'panel.requestToTeacher.index',
            'icon' => 'far fa-address-card',

        ],
        [
            'text' => 'Clases',
            'route'  => 'panel.lessons.index',
