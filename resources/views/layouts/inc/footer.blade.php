   ...
   <footer id="footer" class="footer-1">
    ...
    <div class="mt-4">
    <p class="mt-4 float-left">XTROMBA es una auténtica explosión de energía positiva, una elevación emocional de la mente y del cuerpo, basado en un sistema muy aeróbico y súper dinámico.</p>
    </div></div>
    </div>
...
{{--    @endforeach--}}
    ...
    <p><a href="mailto:info@xtromba.com" title="glorythemes">info@xtromba.com</a></p>
    ...
    <li class=""><a title="whatsapp" target="_blank" href="https://web.whatsapp.com/send?phone=34625949396&text=Hola.%20He%20visto%20vuestra%20web%20y%20me%20interesa%20mucho%20este%20nuevo%20m%C3%A9todo%20de%20Xtromba,%20%C2%BFpodr%C3%ADas%20responderme%20a%20algunas%20dudas%20por%20favor?." target="_blank"><i class="fab fa-whatsapp"></i></a></li>
    ...
    <p>Copyright &copy;  {{ date('Y') }}  Xtromba, Todos los derechos reservados. </p>
    </div>
    </div>
    </div>
    </div>
